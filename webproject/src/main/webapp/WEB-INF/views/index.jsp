    ...
    <div class="king-layout2-main mt15" style="width:960px;">
        <form class="form-horizontal">
            <div class="form-group clearfix ">
                ...
                <div class="col-sm-9">
                    <select name="" id="businessSelect" class="form-control bk-valign-top">
                    </select>
                </div>
            </div>
            <div class="form-group clearfix ">
                ...
                <div class="col-sm-9">
                    <select name="" id="osType" class="form-control bk-valign-top">
            ...
            <div class="form-group clearfix ">
                ...
                <div class="col-sm-9">
                    <input  id="ipAddress" placeholder="请输入ip" class="form-control bk-valign-top"/>
                </div>
            </div>
            <div class="form-group clearfix ">
                <label class="col-sm-3 control-label bk-lh30 pt0">port：</label>
                <div class="col-sm-9">
                    <input  id="port" placeholder="请输入端口" class="form-control bk-valign-top"/>
                </div>
            </div>
            <div class="form-group clearfix ">
                <label class="col-sm-3 control-label bk-lh30 pt0">账号：</label>
                <div class="col-sm-9">
                    <input  id="account" placeholder="请输入账号" class="form-control bk-valign-top"/>
                </div>
            </div>
            <div class="form-group clearfix ">
                <label class="col-sm-3 control-label bk-lh30 pt0">密码：</label>
                <div class="col-sm-9">
                    <input  id="password" placeholder="请输入密码" class="form-control bk-valign-top"/>
                </div>
            </div>
            <div class="form-group clearfix">
...
<script>
    ...
    $.ajax({
        type: "GET",
        url: "${sessionScope.SITE_URL}rest/business/list",
        cache: false, //禁用缓存
        dataType: "json",
        success: function (result) {
            console.log(result);
            if(result.result){
                result.data.info.forEach(function (value) {
                    var html  = " <option value='"+value.bk_biz_id+"'>"+value.bk_biz_name+"</option>";
                    $("#businessSelect").append(html)
                });
            }
        }
    });
    ...
    $.ajax({
        type: "GET",
        url: "${sessionScope.SITE_URL}rest/onlineHosts",
        cache: false, //禁用缓存
        dataType: "json",
        success: function (result) {
            ...
            list.forEach(function (value) {
                index ++;
                var ip = value.host.bk_host_innerip;
                var oSType= value.host.bk_os_name;
                var html  ="<tr>" +
                    "                        <td>" +
